  ...
  return (
    <div className="bg-gray-800 mt-20 container mx-auto max-w-[80%] overflow-none rounded rounded-lg flex sm:flex-row xs:flex-col">
      ...
      <div className="bg-gray-800  p-8">
        <h2 className="sm:text-3xl xs:text-2xl font-bold mb-4 text-yellow-400">
          SUPERHEROINE ERA
        </h2>
        <h3 className="text-2xl mb-4 text-yellow-400">ABOUT US</h3>
        ...
        <h3 className="text-2xl mb-4 text-yellow-400">TO OUR HOLDERS:</h3>
        <p className="mb-6 text-white xs:text-xs text-sm">
