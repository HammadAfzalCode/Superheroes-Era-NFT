  ...
  return (
    <div className="relative   text-white flex justify-center items-center overflow-none ">
      <div className="w-full xs:w-[60%] sm:w-[60%] flex flex-col  items-center justify-center p-4">
        <h1 className="text-h1 sm:text-h1 md:text-h1 lg:text-h1 xl:text-h1 font-sans font-bold text-[#ECD200] uppercase tracking-wider text-center">
          Digital Collectibles For
          <br /> The Creator Economy
        </h1>
        <p className="font-sans font-medium my-4 text-p sm:text-p md:text-p lg:text-p xl:text-p text-center">
          Discover Superheroine Erza, join The League and gain prime
          <br /> access to exclusive information and giveaways.
        </p>

        <button className="bg-[#ECD200] text-black px-6 py-2 border border-black rounded-full hover:bg-black transition duration-300 ease-in-out">
          Let's Explore
        </button>
      </div>
